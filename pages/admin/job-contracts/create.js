...
const AdminJobContractCreatePage = ({user}) => {
    ...
    const header = (
        <PageHeader pretitle="Contract" title="Create Contract" button={<BackButton/>} separator={true}>
        </PageHeader>
    );
    ...
    return (
        <LayoutPage header={header} user={user}>
            <Section borderBottom={true} style={{padding: "2rem 0"}}>
                ...
                {/*                        return (*/}
                {/*                            <Select.Option key={postCategories[index].id} value={postCategories[index].id}>{getObjectTrans(postCategories[index].title)}</Select.Option>*/}
                {/*                        )*/}
                {/*                    })}*/}
                {/*                </InputSelect>*/}
                {/*            </ListItem>*/}
...
export default AdminJobContractCreatePage;
