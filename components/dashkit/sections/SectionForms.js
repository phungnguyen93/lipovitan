...
const AdminSectionForms = ({ children, ...rest }) => {
  ...
  <h1>Something</h1>
      ...
      {/* --------- TEXT EDITOR --------- */}
      <SectionHeader title="Text editor" size={2} spaceBottom={false} />
      ...
      <Card style={{ marginBottom: "0px" }}>
        <CardHeader>
          ...
          <a href="https://ckeditor.com/docs/ckeditor5/latest/builds/guides/integration/frameworks/react.html#quick-start">
            Get started here!
          </a>
        </CardHeader>
        <CardBody>
          <TextArea height="100px" defaultValue="Chưa làm kịp!" />
        </CardBody>
      </Card>
