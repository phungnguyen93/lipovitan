...
const SectionCertificate1 = (props) => {
                ...
                <HorizontalList itemSize={ListItemSize.AUTO}>
                    <ListItem style={{ marginRight: "1rem" }}>
                        <Input
                            ...
                            placeholder="CAM KẾT SẢN PHẨM CHẤT LƯỢNG"
                        />
                    </ListItem>
                </HorizontalList>
                <HorizontalList itemSize={ListItemSize.AUTO}>
                    <ListItem>
                        <TextArea
                            ...
                            placeholder="Sản phẩm Panel PIR được kiểm định chất lượng đạt chuẩn Quốc tế. "
                            height="100px"
                        />
                    </ListItem>
                </HorizontalList>
...
export default SectionCertificate1;