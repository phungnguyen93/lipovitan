...
export default function ItemSeriseInJapan ({
    ...
    return (<>
        <div className="itemEffect itemSeriseInJapan" ref={ref} style={style}>

            <div className="contentEffect" ref={scaleRef}>
                <h3 style={nameStyle} className="name">{children}
                  { 
                    name 
                    ? <Button 
                        hasArrow={false}
                        color={colorButton} 
                        background={backgroundButton}> {name} </Button> 
                    : <></> 
                  }
                </h3>
