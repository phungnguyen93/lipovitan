...
const AdminJobLocationCreatePage = ({user}) => {
    ...
    const saveHandler = function () {
        ...
        let loginTimeout = setTimeout(async function () {
            ApiCall({
                router,
                path: `/api/v1/admin/job-locations`,
                token: user.token,
                method: 'POST',
    ...
    const header = (
        <PageHeader pretitle="Working Place" title="Create Working Place" button={<BackButton/>} separator={true}>
...
export default AdminJobLocationCreatePage;
