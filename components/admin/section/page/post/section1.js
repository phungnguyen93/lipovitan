                ...
                <HorizontalList itemSize={ListItemSize.AUTO}>
                    <ListItem style={{ marginRight: "1rem" }}>
                        <Input
                            ...
                            placeholder="Đón đầu xu hướng tiên phong hành động"
                        />
                    </ListItem>
                </HorizontalList>
                <HorizontalList itemSize={ListItemSize.AUTO}>
                    <ListItem>
                        <TextArea
                            ...
                            placeholder="Cuộc sống là dòng chảy luôn vận động và chúng tôi lựa chọn ở vị trí thượng nguồn"
                            height="100px"
                        />
                    </ListItem>
                </HorizontalList>
