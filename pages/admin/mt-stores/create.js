...
const AdminMtStoresCreatePage = ({user}) => {
    ...
    const header = (
        <PageHeader pretitle="Modern Channels" title="Create Channel" button={<BackButton/>} separator={true}>
        </PageHeader>
    );
...
export default AdminMtStoresCreatePage;
