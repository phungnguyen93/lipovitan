...
const AdminOfficesEditPage = ({user}) => {
    ...
    const header = (
        <PageHeader pretitle="Office" title="Update Office" button={<BackButton/>} separator={true}>
        </PageHeader>
    );
...
export default AdminOfficesEditPage;
