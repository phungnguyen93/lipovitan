...
const AdminPostCategoriesCreatePage = ({user}) => {
    ...
    const header = (
        <PageHeader pretitle="Category" title="Create Category" button={<BackButton/>} separator={true}>
        </PageHeader>
    );
                            ...
                            ? Object.keys(locales).map(function (locale) {
                                return (
                                    <TabPane forceRender={true} tab={locales[locale]} key={locale}>
                                        ...
                                        {/*            label={<label style={{display: "inline-block"}}>Add Section <span*/}
                                        ...
                                        {/*                return (*/}
                                        {/*                    <Select.Option key={`SectionBox${index}`}*/}
                                        {/*                                   value={index + 1}>{name}</Select.Option>*/}
                                        {/*                )*/}
                                        {/*            }) : ''}*/}
                                        {/*        </InputSelect>*/}
                                        {/*    </ListItem>*/}
